...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x00000f28eb4863d6a6daeb826c62475073df471f047eee1fdbafc84314390b7e");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Angora: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Angora Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000f28eb4863d6a6daeb826c62475073df471f047eee1fdbafc84314390b7e");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AngoraMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AngoraCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("AngoraMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Angora-miner");
    ...
    try { loop {
        ...
        printf("Running AngoraMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
